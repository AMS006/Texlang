...
const { getDownloadUrl, uploadFileToFirebaseStorage } = require("../../helper");
...
exports.uploadUserProjectWork = async(req,res)=>{
    try {
        ...
        workData.targetLanguage[Number(idx)] = {downloadPath:filePath,lang:workData.targetLanguage[Number(idx)].lang}
